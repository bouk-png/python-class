...
def search_player(ultimate_player_list):#선수를 검색하는 함수이다. (이름, 포지션, 나이 등으로 검색 ok) 
    ...
    if x in ["1", "2", "3"]:
        ...
        if x == 1:
            ...
            if pos_found == 0:
                print("잘못 입력하셨거나 해당 포지션을 가진 선수가 없습니다.")
            print("")        
    else:
        print("잘못 입력하셨습니다.")
        print()
...
def player_lent(my_player_list):                       #선수 임대 함수
    ...
    #임대중이 아니면 lent하기
        ...
        #*******에러 방지하기**********
            ...
            cont_p = int(my_player_list[lent_index].player_contract_period)
...
while 1:
    ...
    if select_menu in ["1", "2", "3", "4", "5", "6", "7", "8", "0"]:
        ...
        if select_menu == 1:
            ...
            player_lent(ultimate_player_list)
            
        elif select_menu == 4:
            add_player(ultimate_player_list)
